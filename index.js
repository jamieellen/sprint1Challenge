...
function addArtist(array, nameValue, yearsValue, genreValue, nationalityValue, bioValue) {
  ...
  paramCopy.push(newInfo);
  return paramCopy;
}
console.log(artists, "John Doe", "1988-2022", "Full Stack Developement", "African American", "I have a background in customer service ar Big Retail Chain. I am attending Bloomtech to become a Fronted Developer.");
...
function artistByCountry(array, chosenNationality){
  let newArray = [];
  for(let i = 0; i < array.length; i++) {
    if(array[i].nationality === chosenNationality) {
